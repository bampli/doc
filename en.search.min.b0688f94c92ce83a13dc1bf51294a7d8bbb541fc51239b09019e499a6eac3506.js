...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.6f013baa40776f900a959be2c659ddec489fbc238a61006f7f31aeef2ea7f70f.js',function(){input.required=false;search();});}
