...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.ed6a4c3253715fec4ef089b99abf1a44fe70186475f846d2732366ef58dd6452.js',function(){input.required=false;search();});}
