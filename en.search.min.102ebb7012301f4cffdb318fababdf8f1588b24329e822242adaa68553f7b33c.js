...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.04d77e8d2101ca35a2b346b21cb0e2da796566cff30919b0007b38d522fad40f.js',function(){input.required=false;search();});}
