...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.52aba06a12351f39543b4783cc11931f6a264a4985e67be3f579afb546d2c8d1.js',function(){input.required=false;search();});}
