...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.e93fa129064f4477a406ddf654f9d80b1aabbf401b1cd23a5590d91ff957e62e.js',function(){input.required=false;search();});}
