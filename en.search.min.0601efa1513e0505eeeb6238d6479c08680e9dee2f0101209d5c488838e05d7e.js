...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.8eb76d2d15c77aff79d7996cda026b999577a9ecfe1a880b4501bb2c463af46a.js',function(){input.required=false;search();});}
