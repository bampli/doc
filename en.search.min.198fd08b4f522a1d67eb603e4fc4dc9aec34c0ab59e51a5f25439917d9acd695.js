...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.7f66c94f85fd3196bf2307dcee3e5f09b059e2c164d42dffd68e524d0965e809.js',function(){input.required=false;search();});}
