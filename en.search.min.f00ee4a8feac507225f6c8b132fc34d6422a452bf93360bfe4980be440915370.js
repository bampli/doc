...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.9dd0b3ca058009de2571b88eded975554dab83c5e22bfac6bb744c1bb3f6ea08.js',function(){input.required=false;search();});}
