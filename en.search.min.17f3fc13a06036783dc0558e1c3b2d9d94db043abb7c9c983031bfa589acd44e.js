...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.9df3cfeefc103cceeb0337074c011832faf9bb65d2e0de8bf97ccd2970343777.js',function(){input.required=false;search();});}
