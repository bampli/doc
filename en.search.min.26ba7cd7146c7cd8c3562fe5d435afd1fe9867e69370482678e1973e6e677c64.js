...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.42337512407d6e9f1939940ae652dee2804d8dc087cd0effa09416a07acd5b05.js',function(){input.required=false;search();});}
