...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.0c1b60b91a30efa9573cfabbdb204c7b4cb8fea05c70e30fb19d1d8a49ba1338.js',function(){input.required=false;search();});}
