...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.7b6860565b0ac7df13ef30b515d02c5bdcf4bee7be154664515c5c770d89f4f6.js',function(){input.required=false;search();});}
