...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.4c65c38f7e5b34553f20a05c4a3d77ed91b150608392d7155faa40ab845efd76.js',function(){input.required=false;search();});}
