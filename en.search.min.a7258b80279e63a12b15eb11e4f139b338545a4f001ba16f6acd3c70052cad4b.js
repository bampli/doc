...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.bc8a93994199dee3eaa30b6faa86950bb53a843f0cb99ee1ae497891743dc4f9.js',function(){input.required=false;search();});}
