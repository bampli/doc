...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.7e30333975a28ab9652c47ce9c641b816bad48e4bd6d66e9da5c1a248773da60.js',function(){input.required=false;search();});}
