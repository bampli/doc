...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.2c730cac076a5424ad5b554cb216a39df7726139a86811843428993322e34101.js',function(){input.required=false;search();});}
