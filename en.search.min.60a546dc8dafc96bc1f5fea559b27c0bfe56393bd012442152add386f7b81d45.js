...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.45b212d03656abfd9ce639094863c933791c5032e255bf7c6d768f4411b86637.js',function(){input.required=false;search();});}
