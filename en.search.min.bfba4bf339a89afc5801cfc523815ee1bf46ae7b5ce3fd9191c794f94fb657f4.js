...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.92744c87d9f22e63dadcff164cc9c3018b6ba585e5fdfa583e5d9cf10542c71d.js',function(){input.required=false;search();});}
