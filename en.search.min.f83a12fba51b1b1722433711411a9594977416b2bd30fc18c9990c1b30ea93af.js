...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.440abca5a28beccf8cfd18600c7c12070380c17a3bb8a035b914311e380ec9a4.js',function(){input.required=false;search();});}
