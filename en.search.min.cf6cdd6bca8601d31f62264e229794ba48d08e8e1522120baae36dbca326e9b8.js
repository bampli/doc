...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.5744145fac803adefaa649ed910a2e6f6459b3b83e1b18f521b7a3a1b740fc86.js',function(){input.required=false;search();});}
