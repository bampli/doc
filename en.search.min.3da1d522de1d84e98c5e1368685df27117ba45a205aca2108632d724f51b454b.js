...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/flexsearch.min.js');loadScript('/docs/en.search-data.min.6c33c77e2be1002d656d41f578ec28e5dd61576a39031b06c79977e77e25a688.js',function(){input.required=false;search();});}
